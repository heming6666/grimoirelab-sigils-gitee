...
setup(name="grimoirelab-panels-gitee",
      description="Panels and visualizations for GrimoireLab Gitee dashboards",
      long_description=long_description,
      long_description_content_type='text/markdown',
      url="https://github.com/heming6666/grimoirelab-sigils-gitee",
      version=version,
      author="X-lab",
      ...
      namespace_packages=['panels','panels.json'],
